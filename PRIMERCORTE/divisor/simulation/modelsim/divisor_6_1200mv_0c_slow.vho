...
-- out1	=>  Location: PIN_V12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \count~1_combout\ = (!\Equal0~7_combout\ & \Add0~26_combout\)
...
-- Equation(s):
-- \Equal0~6_combout\ = (count(22) & (!count(23) & (count(21) & count(20))))
...
-- Equation(s):
-- \Equal0~5_combout\ = (!count(17) & (count(19) & (count(18) & count(16))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (count(14) & (count(12) & (!count(15) & count(13))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!count(9) & (!count(8) & (count(11) & !count(10))))
...
-- Equation(s):
-- \Equal0~3_combout\ = (count(0) & (count(1) & (count(2) & count(3))))
