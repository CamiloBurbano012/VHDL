...
\solicitudes_subir_int~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \solicitudes_subir_int~0_combout\ = (!\clear_request_subir[0]~input_o\ & ((solicitudes_subir_int(0)) # (\BOTON_SUBIR[0]~input_o\)))
...
PORT MAP (
	...
	datac => solicitudes_subir_int(0),
	datad => \BOTON_SUBIR[0]~input_o\,
	combout => \solicitudes_subir_int~0_combout\);
...
\solicitudes_subir_int[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	...
	d => \solicitudes_subir_int~0_combout\,
	clrn => \ALT_INV_reset~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => solicitudes_subir_int(0));
...
\solicitudes_subir_int~1\ : cycloneiii_lcell_comb
-- Equation(s):
-- \solicitudes_subir_int~1_combout\ = (!\clear_request_subir[1]~input_o\ & ((solicitudes_subir_int(1)) # (\BOTON_SUBIR[1]~input_o\)))
...
PORT MAP (
	...
	datac => solicitudes_subir_int(1),
	datad => \BOTON_SUBIR[1]~input_o\,
	combout => \solicitudes_subir_int~1_combout\);

-- Location: FF_X40_Y26_N5
\solicitudes_subir_int[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \clk_1Hz~inputclkctrl_outclk\,
	d => \solicitudes_subir_int~1_combout\,
	clrn => \ALT_INV_reset~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => solicitudes_subir_int(1));
...
\solicitudes_subir_int~2\ : cycloneiii_lcell_comb
-- Equation(s):
-- \solicitudes_subir_int~2_combout\ = (!\clear_request_subir[2]~input_o\ & ((\BOTON_SUBIR[2]~input_o\) # (solicitudes_subir_int(2))))
...
PORT MAP (
	...
	datac => solicitudes_subir_int(2),
	datad => \clear_request_subir[2]~input_o\,
	combout => \solicitudes_subir_int~2_combout\);

-- Location: FF_X26_Y28_N1
\solicitudes_subir_int[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \clk_1Hz~inputclkctrl_outclk\,
	d => \solicitudes_subir_int~2_combout\,
	clrn => \ALT_INV_reset~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => solicitudes_subir_int(2));
...
\solicitudes_subir_int~3\ : cycloneiii_lcell_comb
-- Equation(s):
-- \solicitudes_subir_int~3_combout\ = (!\clear_request_subir[3]~input_o\ & ((solicitudes_subir_int(3)) # (\BOTON_SUBIR[3]~input_o\)))
...
PORT MAP (
	...
	datac => solicitudes_subir_int(3),
	datad => \BOTON_SUBIR[3]~input_o\,
	combout => \solicitudes_subir_int~3_combout\);

-- Location: FF_X21_Y28_N1
\solicitudes_subir_int[3]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \clk_1Hz~inputclkctrl_outclk\,
	d => \solicitudes_subir_int~3_combout\,
	clrn => \ALT_INV_reset~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => solicitudes_subir_int(3));
...
\solicitudes_bajar_int~0\ : cycloneiii_lcell_comb
-- Equation(s):
-- \solicitudes_bajar_int~0_combout\ = (!\clear_request_bajar[0]~input_o\ & ((solicitudes_bajar_int(0)) # (\BOTON_BAJAR[0]~input_o\)))
...
PORT MAP (
	...
	datac => solicitudes_bajar_int(0),
	datad => \BOTON_BAJAR[0]~input_o\,
	combout => \solicitudes_bajar_int~0_combout\);

-- Location: FF_X40_Y26_N3
\solicitudes_bajar_int[0]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \clk_1Hz~inputclkctrl_outclk\,
	d => \solicitudes_bajar_int~0_combout\,
	clrn => \ALT_INV_reset~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => solicitudes_bajar_int(0));
...
\solicitudes_bajar_int~1\ : cycloneiii_lcell_comb
-- Equation(s):
-- \solicitudes_bajar_int~1_combout\ = (!\clear_request_bajar[1]~input_o\ & ((solicitudes_bajar_int(1)) # (\BOTON_BAJAR[1]~input_o\)))
...
PORT MAP (
	...
	datac => solicitudes_bajar_int(1),
	datad => \BOTON_BAJAR[1]~input_o\,
	combout => \solicitudes_bajar_int~1_combout\);

-- Location: FF_X28_Y28_N1
\solicitudes_bajar_int[1]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \clk_1Hz~inputclkctrl_outclk\,
	d => \solicitudes_bajar_int~1_combout\,
	clrn => \ALT_INV_reset~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => solicitudes_bajar_int(1));
...
\solicitudes_bajar_int~2\ : cycloneiii_lcell_comb
-- Equation(s):
-- \solicitudes_bajar_int~2_combout\ = (!\clear_request_bajar[2]~input_o\ & ((solicitudes_bajar_int(2)) # (\BOTON_BAJAR[2]~input_o\)))
...
PORT MAP (
	...
	datac => solicitudes_bajar_int(2),
	datad => \BOTON_BAJAR[2]~input_o\,
	combout => \solicitudes_bajar_int~2_combout\);

-- Location: FF_X1_Y23_N17
\solicitudes_bajar_int[2]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \clk_1Hz~inputclkctrl_outclk\,
	d => \solicitudes_bajar_int~2_combout\,
	clrn => \ALT_INV_reset~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => solicitudes_bajar_int(2));
...
\solicitudes_bajar_int~3\ : cycloneiii_lcell_comb
-- Equation(s):
-- \solicitudes_bajar_int~3_combout\ = (!\clear_request_bajar[3]~input_o\ & ((\BOTON_BAJAR[3]~input_o\) # (solicitudes_bajar_int(3))))
...
PORT MAP (
	...
	datac => solicitudes_bajar_int(3),
	datad => \clear_request_bajar[3]~input_o\,
	combout => \solicitudes_bajar_int~3_combout\);

-- Location: FF_X40_Y26_N17
\solicitudes_bajar_int[3]\ : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \clk_1Hz~inputclkctrl_outclk\,
	d => \solicitudes_bajar_int~3_combout\,
	clrn => \ALT_INV_reset~inputclkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => solicitudes_bajar_int(3));
